...
(birth_year..2023).each do |one_year| #on crée une intervalle entre l'année donnée par l'utilisateur et on nomme chacune (each) des valeurs comprises dans l'intervalle = "one_year"
    ...
    #on demande d'afficher les années de la variable ensuite une soustraction pour calculer l'age à l'année indiquée, tout s'affiche car it falls under "puts" grace aux accolades
end